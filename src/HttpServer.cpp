...
function saveStream(id) {
  ...
  const payload = {
    ...
    audio_delay_ms: Math.max(0, Math.min(5000, Number(document.getElementById('streamAudioDelayMs')?.value || 0))),
